...
<template>
  <div class="activity-area" :style="{ width:seatAreaWidthRem + 'rem',height:seatAreaHeightRem + 'rem'}">
    <div class="screen">
      <div class="screen-text">{{ this.$route.query.hallName }}</div>
    </div>
    <div v-show="thumbnailShow" class="thumbnail" :style="{ transform: 'scale('+seatScale+')',width:thumbnailWidthRem + 'rem',height:thumbnailHeighthRem + 'rem'}">
      <!--红色外框开始-->
    ...
    <div class="seat-tool-parent" :style="{height:seatAreaHeightRem + 'rem'}">
      <div
        class="seat-tool"
        :style="{transform: 'scale('+seatScale+')',transformOrigin: transformOriginTool,marginTop:seatToolMargin+'rem',
